...
export const INITIAL_SLIDESHOW_IMAGES = [
  {
    ...
    subtitle: "Talents Meet Highlights 2K26",
    category: "Stage",
  ...
  },
  {
    ...
    subtitle: "Misty Coastline & Reflections",
    category: "General",
    aspect_ratio: "portrait",
  },
  {
    ...
    subtitle: "Artistic Expression Series",
    category: "Off-Stage",
    aspect_ratio: "square",
  },
  {
    ...
    title: "Warm Comfort & Textiles",
    subtitle: "Contemporary Interior Art",
    category: "General",
    aspect_ratio: "square",
  },
  {
    ...
    title: "Curtains & Soft Lighting",
    subtitle: "Atmospheric Stage Ambiance",
    category: "Stage",
    aspect_ratio: "portrait",
  },
  {
    ...
    title: "Geometric Forms & Balance",
    subtitle: "Brutalist Shapes Showcase",
    category: "General",
    aspect_ratio: "portrait",
  },
  {
    ...
    subtitle: "Minimal Product Showcase",
    category: "Off-Stage",
    aspect_ratio: "square",
  },
  {
    ...
    subtitle: "Nature & Botanical Harmony",
    category: "General",
    aspect_ratio: "square",
  },
  {
    ...
    title: "Abstract Wave Form",
    subtitle: "Linear Aesthetics",
    category: "Off-Stage",
    aspect_ratio: "square",
  },
  {
